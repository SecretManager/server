...
public enum MembershipType {
    ...
    PREMIUM(15_000, 100_000_000, true, 100),
    ELITE(25_000, 200_000_000, true, 100),
    ULTRA(40_000, 500_000_000, true, 100),
    ;

    private final int pricePerMonth;
    private final int savedFileLimitByte;
    private final boolean isAdBlock;
    private final int maxDownloadCountPerFileForMonth;

    MembershipType(
            int pricePerMonth,
            int savedFileLimitByte,
            boolean isAdBlock,
